...
public class View {
    ...
    public Student inputStudent(Manager m) {
        while (true) {
            ...
            ArrayList<Student> findById = m.studentListFindById(id);
            String studentName;
            ...
            if (!m.checkStudentExist(m, id, studentName, semester, courseName)) {
                return new Student(id.toUpperCase(), studentName.toUpperCase(), semester.toUpperCase(), courseName.toUpperCase());                
            }
