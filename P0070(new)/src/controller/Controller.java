...
public class Controller {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    ebank.setLocale(new Locale.Builder().setLanguage("vi").setRegion("VN").build());
                    //lấy tệp ngôn ngữ vi dựa theo biến local
                    ebank.bundle = ResourceBundle.getBundle("language/Vi", ebank.locale);
                    //chạy hàm xử lý logic
                    handle();
                    break;
                case 2:
                    //set biến local ngôn ngữ 
                    ebank.setLocale(new Locale.Builder().setLanguage("en").setRegion("US").build());
                    //lấy tệp ngôn ngữ vi dựa theo biến local
                    ebank.bundle = ResourceBundle.getBundle("language/En", ebank.locale);
                    //chạy hàm xử lý logic
                    handle();
                    break;
                case 3:
    ...
    void handle() {
        while (true) {
            ...
            String accountNumber = inputter.getString(ebank.bundle.getString("account"));
        ...
        while (true) {
            ...
            String password = inputter.getString(ebank.bundle.getString("password"));
        ...
        while (true) {
            ...
            inputter.displayNotice(ebank.bundle.getString("captcha") + captchaGenerate);     
            //step 13: nhập chuỗi capcha từ bàn phím
            String captchaInput = inputter.getString(ebank.bundle.getString("captcha"));  
