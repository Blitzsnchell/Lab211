...
public class Validate {
    ...
    //check user input string allow empty
    public static String checkInputStringWithDefault(String defaultValue) {
        //loop until user input correct
        while (true) {
            String result = in.nextLine().trim();
            if (result.isEmpty()) {
    ...
    //check user input int
    public static int checkInputIntWithDefault(int defaultValue) {
        //loop until user input correct
        while (true) {
            try {
                String result = in.nextLine().trim();
