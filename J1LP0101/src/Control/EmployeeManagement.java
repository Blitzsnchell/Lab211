...
public class EmployeeManagement {
    ...
    public void addEmployee(ArrayList<Employee> listEmployee) {
        String id;
    ...
    public void updateEmployees(ArrayList<Employee> listEmployee) {
        String id;
        int choice;
    ...
    public int findIndexEmployeeByID(ArrayList<Employee> listEmployee, String id) {
    ...
    public void reremoveEmployee(ArrayList<Employee> listEmployee) {
        String id;
        //check list employee empty
        if (listEmployee.isEmpty()) {
            System.out.println("List employee is empty");
    ...
    public void swap(ArrayList<Employee> listEmployee, int j, int i) {
    ...
    public void sortEmployeeBySalary(ArrayList<Employee> listEmployee) {
        //Check list is emty
        if (listEmployee.isEmpty()) {
            System.out.println("List employee is empty");
        } else {
    ...
    //Search employees
    public void searchInformationByName(ArrayList<Employee> listEmployee) {
        //Check list is emty
        if (listEmployee.isEmpty()) {
            System.out.println("List employee is empty");
        } else {
